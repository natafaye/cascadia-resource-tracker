    ...
    return (
        <div className={clsx(className, "flex p-3 items-center justify-center")}>
            ...
            <div className="flex ms-4 border-2 border-white rounded-xl">
                <div className="bg-white p-3 text-2xl text-black rounded-s-lg w-12 flex items-center justify-center">
                    {tally}
                </div>
                <div className="flex flex-col gap-1 text-xl text-white p-1">
                    <button
                        className={clsx("p-1 rounded-tr-lg", highlightClassName)}
                        onClick={() => updateTally(name, 1)}
                    >
                        <FaPlus />
                    </button>
                    <button
                        className={clsx("p-1 rounded-br-lg", highlightClassName, "disabled:opacity-50")}
                        onClick={() => updateTally(name, -1)}
                        disabled={tally === 0}
                    >
                        <FaMinus />
